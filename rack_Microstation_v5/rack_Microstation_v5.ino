...
const char Topic[] = "esp32/output";  // Topic to subcribe to
...
void loop() {
  ...
  if ((Hours) == 23 && (Minutes) ==42 && (Seconds) == 00) {
  ...
  client.publish("esp32/notificaciones",  "probando mqtt notificaciones");
...
//      digitalWrite(waterpump_soil, HIGH);
//      digitalWrite(Solenoid_Valvule_4 , HIGH);
//      Serial.println("irrigation_2b done");
//
//
//
//    else {
//      Serial.println("humidity_2b ok");
//
//      return;
//    }
//  }
